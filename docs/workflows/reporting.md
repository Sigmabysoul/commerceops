...
only when their immutable batch reference belongs to that marketplace. Stock-in,
manual adjustments, and corrections remain company-wide because those ledger
events do not belong to a marketplace. Filtered net movement is therefore the
company-wide stock-in/adjustment/correction total plus ecommerce stock-out for
the selected marketplace. Current on-hand, reserved, and available also remain
company-wide live snapshots; they are not marketplace-owned balances.
