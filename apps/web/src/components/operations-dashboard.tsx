...
export function OperationsDashboard() {
  ...
  return <section className="reporting">
    ...
    {report&&<>
      ...
      {report.inventory_access&&<Table title={`Product movement (${report.product_movement_total})`} headers={["Product","Orders","Stock in","Stock out","Return restock","Adjustments","Net"]} rows={report.product_movements.map(x=>[`${x.product_name} · ${x.internal_code}`,x.order_quantity,x.stock_in,x.stock_out,x.return_restock,x.adjustments,x.net_movement])}/>}
    </>}
  </section>;
}
